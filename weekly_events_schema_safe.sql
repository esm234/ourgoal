-- Weekly Events System Database Schema (Safe Version)
...
-- 5. Auto-update Functions (Safe Creation)
-- ===================================================================
...
DROP TRIGGER IF EXISTS trigger_update_weekly_events_updated_at ON public.weekly_events;
...
DROP POLICY IF EXISTS "Admins can manage events" ON public.weekly_events;
DROP POLICY IF EXISTS "Users can view questions for enabled events" ON public.event_questions;
DROP POLICY IF EXISTS "Admins can manage questions" ON public.event_questions;
...
DROP POLICY IF EXISTS "Admins can view all participations" ON public.event_participations;
