...
const FAQ: React.FC = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    // الجزء اللفظي
    {
      ...
      answer: 'اقرأ كثيراً من مصادر متنوعة، احفظ المرادفات والأضداد، تدرب على فهم المعاني من السياق، وحل أسئلة التناظر اللفظي بانتظام.',
      category: 'verbal',
    ...
    // الجزء الكمي
    {
      ...
      answer: 'راجع الأساسيات أولاً، تدرب على حل المسائل بطرق مختلفة، استخدم الحاسبة بكفاءة، وركز على فهم المفاهيم بدلاً من الحفظ.',
    ...
    // يوم الاختبار
    {
      ...
      answer: 'أحضر هويتك الأصلية، قلم رصاص HB، ممحاة، مسطرة، حاسبة علمية مسموحة، وزجاجة ماء. تأكد من قائمة المواد المسموحة من موقع قياس.',
      category: 'exam-day',
      tags: ['اختبار', 'أدوات', 'تحضير'],
      isPopular: true
    },
    {
      id: '9',
    ...
    // تقنية ونصائح
    {
      ...
      answer: 'اذهب لصفحة مولد الخطة، أدخل تاريخ اختبارك، اختر عدد جولات المراجعة (ننصح بـ 2-3)، واضغط إنشاء. ستحصل على جدول مفصل بالاختبارات اليومية.',
      category: 'platform',
