    ...
    <Layout>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-[#1A2237] to-[#111827]">
        <div className="container mx-auto">
          ...
          {/* Team Members Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Team member cards would go here, keeping the existing functionality but with updated styling */}
            {/* I'm adding a placeholder design that you can duplicate for each team member */}
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden group hover:bg-white/10 transition-all duration-300 hover:-translate-y-2">
              <div className="aspect-[3/2] overflow-hidden">
                ...
                <div className="p-6">
                <h3 className="text-xl font-bold text-white mb-1">اسم عضو الفريق</h3>
                <p className="text-primary/90 mb-4">المسمى الوظيفي</p>
                <p className="text-gray-300 text-sm">وصف مختصر لدور عضو الفريق وخبراته في مجال اختبارات قياس والتعليم.</p>
            ...
            {/* More team members would go here */}
          </div>
        </div>
      </section>
    </Layout>
